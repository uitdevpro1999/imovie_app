...
mixin _$LanguageState {
 ...
 PageStatus get pageStatus; bool get processing; AppFailure? get failure; String get selectedLanguageCode;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LanguageState&&(identical(other.pageStatus, pageStatus) || other.pageStatus == pageStatus)&&(identical(other.processing, processing) || other.processing == processing)&&(identical(other.failure, failure) || other.failure == failure)&&(identical(other.selectedLanguageCode, selectedLanguageCode) || other.selectedLanguageCode == selectedLanguageCode));
}


@override
int get hashCode => Object.hash(runtimeType,pageStatus,processing,failure,selectedLanguageCode);

@override
String toString() {
  return 'LanguageState(pageStatus: $pageStatus, processing: $processing, failure: $failure, selectedLanguageCode: $selectedLanguageCode)';
}
...
@useResult
$Res call({
 PageStatus pageStatus, bool processing, AppFailure? failure, String selectedLanguageCode
});
...
/// Create a copy of LanguageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pageStatus = null,Object? processing = null,Object? failure = freezed,Object? selectedLanguageCode = null,}) {
...
as AppFailure?,selectedLanguageCode: null == selectedLanguageCode ? _self.selectedLanguageCode : selectedLanguageCode // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of LanguageState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PageStatus pageStatus,  bool processing,  AppFailure? failure,  String selectedLanguageCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
return $default(_that.pageStatus,_that.processing,_that.failure,_that.selectedLanguageCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PageStatus pageStatus,  bool processing,  AppFailure? failure,  String selectedLanguageCode)  $default,) {final _that = this;
switch (_that) {
case _LanguageState():
return $default(_that.pageStatus,_that.processing,_that.failure,_that.selectedLanguageCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PageStatus pageStatus,  bool processing,  AppFailure? failure,  String selectedLanguageCode)?  $default,) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
return $default(_that.pageStatus,_that.processing,_that.failure,_that.selectedLanguageCode);case _:
  return null;
...
class _LanguageState extends LanguageState {
  const _LanguageState({this.pageStatus = PageStatus.loaded, this.processing = false, this.failure, this.selectedLanguageCode = 'vi'}): super._();
  

@override@JsonKey() final  PageStatus pageStatus;
@override@JsonKey() final  bool processing;
@override final  AppFailure? failure;
@override@JsonKey() final  String selectedLanguageCode;
...
/// Create a copy of LanguageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pageStatus = null,Object? processing = null,Object? failure = freezed,Object? selectedLanguageCode = null,}) {
