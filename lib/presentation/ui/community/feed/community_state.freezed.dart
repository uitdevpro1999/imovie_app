...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommunityState&&(identical(other.mineOnly, mineOnly) || other.mineOnly == mineOnly)&&(identical(other.pageStatus, pageStatus) || other.pageStatus == pageStatus)&&(identical(other.processing, processing) || other.processing == processing)&&(identical(other.failure, failure) || other.failure == failure)&&const DeepCollectionEquality().equals(other.stories, stories)&&const DeepCollectionEquality().equals(other.posts, posts)&&(identical(other.page, page) || other.page == page)&&(identical(other.pageSize, pageSize) || other.pageSize == pageSize)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.loadingMore, loadingMore) || other.loadingMore == loadingMore)&&const DeepCollectionEquality().equals(other.commentsByPost, commentsByPost)&&const DeepCollectionEquality().equals(other.loadingCommentPostIds, loadingCommentPostIds));
}


@override
int get hashCode => Object.hash(runtimeType,mineOnly,pageStatus,processing,failure,const DeepCollectionEquality().hash(stories),const DeepCollectionEquality().hash(posts),page,pageSize,hasMore,loadingMore,const DeepCollectionEquality().hash(commentsByPost),const DeepCollectionEquality().hash(loadingCommentPostIds));

@override
String toString() {
  return 'CommunityState(mineOnly: $mineOnly, pageStatus: $pageStatus, processing: $processing, failure: $failure, stories: $stories, posts: $posts, page: $page, pageSize: $pageSize, hasMore: $hasMore, loadingMore: $loadingMore, commentsByPost: $commentsByPost, loadingCommentPostIds: $loadingCommentPostIds)';
}
...
@useResult
$Res call({
 bool mineOnly, PageStatus pageStatus, bool processing, AppFailure? failure, List<CommunityStory> stories, List<CommunityPost> posts, int page, int pageSize, bool hasMore, bool loadingMore, Map<String, List<CommunityComment>> commentsByPost, Set<String> loadingCommentPostIds
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool mineOnly,  PageStatus pageStatus,  bool processing,  AppFailure? failure,  List<CommunityStory> stories,  List<CommunityPost> posts,  int page,  int pageSize,  bool hasMore,  bool loadingMore,  Map<String, List<CommunityComment>> commentsByPost,  Set<String> loadingCommentPostIds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommunityState() when $default != null:
return $default(_that.mineOnly,_that.pageStatus,_that.processing,_that.failure,_that.stories,_that.posts,_that.page,_that.pageSize,_that.hasMore,_that.loadingMore,_that.commentsByPost,_that.loadingCommentPostIds);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool mineOnly,  PageStatus pageStatus,  bool processing,  AppFailure? failure,  List<CommunityStory> stories,  List<CommunityPost> posts,  int page,  int pageSize,  bool hasMore,  bool loadingMore,  Map<String, List<CommunityComment>> commentsByPost,  Set<String> loadingCommentPostIds)  $default,) {final _that = this;
switch (_that) {
case _CommunityState():
return $default(_that.mineOnly,_that.pageStatus,_that.processing,_that.failure,_that.stories,_that.posts,_that.page,_that.pageSize,_that.hasMore,_that.loadingMore,_that.commentsByPost,_that.loadingCommentPostIds);case _:
  throw StateError('Unexpected subclass');
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CommunityState&&(identical(other.mineOnly, mineOnly) || other.mineOnly == mineOnly)&&(identical(other.pageStatus, pageStatus) || other.pageStatus == pageStatus)&&(identical(other.processing, processing) || other.processing == processing)&&(identical(other.failure, failure) || other.failure == failure)&&const DeepCollectionEquality().equals(other._stories, _stories)&&const DeepCollectionEquality().equals(other._posts, _posts)&&(identical(other.page, page) || other.page == page)&&(identical(other.pageSize, pageSize) || other.pageSize == pageSize)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.loadingMore, loadingMore) || other.loadingMore == loadingMore)&&const DeepCollectionEquality().equals(other._commentsByPost, _commentsByPost)&&const DeepCollectionEquality().equals(other._loadingCommentPostIds, _loadingCommentPostIds));
}


@override
int get hashCode => Object.hash(runtimeType,mineOnly,pageStatus,processing,failure,const DeepCollectionEquality().hash(_stories),const DeepCollectionEquality().hash(_posts),page,pageSize,hasMore,loadingMore,const DeepCollectionEquality().hash(_commentsByPost),const DeepCollectionEquality().hash(_loadingCommentPostIds));
