...
part 'community_profile_state.freezed.dart';

@freezed
abstract class CommunityProfileState
    with _$CommunityProfileState
    implements BaseState {
  const CommunityProfileState._();
  ...
  const factory CommunityProfileState({
    ...
    @Default(false) bool followProcessing,
  ...
  @override
  CommunityProfileState copyWithBase({
