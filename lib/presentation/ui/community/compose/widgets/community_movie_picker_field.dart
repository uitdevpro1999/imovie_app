...
class _CommunityMoviePickerSheet extends StatefulWidget {
  const _CommunityMoviePickerSheet();

  @override
  State<_CommunityMoviePickerSheet> createState() =>
      _CommunityMoviePickerSheetState();
}

class _CommunityMoviePickerSheetState
    extends State<_CommunityMoviePickerSheet> {
